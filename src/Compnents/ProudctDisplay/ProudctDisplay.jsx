        ...
        <>
          ...
          <nav aria-label="Page navigation example">
            ...
            >
              <li onClick={prevPage}>
                <a
                  className={`flex  cursor-pointer items-center justify-center px-3 h-8 ms-0 leading-tight     text-mainColor bg-white border border-e-0 bo rounded-s-lg hover:bg-gray-100 hover:text-opacity-50 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-whiterder-gray-300`}
                >
              ...
              <li onClick={nextPage}>
                <a
                  className={`flex items-center justify-center px-3 h-8 leading-tight cursor-pointer  text-mainColor bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-opacity-50 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white`}
                >
